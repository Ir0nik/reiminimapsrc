...
public class ChunkData
{
    ...
    private void updateEnvironmentColor()
    {
        ...
        if (this.chunk != null)
        {
            byte[] z = this.chunk.getBiomeArray();
            ...
            for (x = 0; x < 256; ++x)
            {
                ...
                BiomeGenBase z1 = BiomeGenBase.getBiomeGenArray()[x1];
                this.biomes[x] = z1 == null ? BiomeGenBase.plains : z1;
            }
        }
        ...
        {
            BiomeGenBase var6 = this.biomes[var5];
            this.waterColors[var5] = var6.waterColorMultiplier;
            x1 = this.xPosition * 16 + (var5 & 15);
            int var7 = this.zPosition * 16 + (var5 >> 4);
            this.foliageColors[var5] = var6.getBiomeFoliageColor(x1, 64, var7);
            this.grassColors[var5] = var6.getBiomeGrassColor(x1, 64, var7);
        }
    ...
    static void init()
    {
        try
        {
            ...
            {
                WorldServer[] e = Minecraft.getMinecraft().getIntegratedServer().worldServers;
