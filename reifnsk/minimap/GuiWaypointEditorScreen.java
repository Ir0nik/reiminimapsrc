...
public class GuiWaypointEditorScreen extends GuiScreen implements GuiScreenInterface
{
    ...
    public GuiWaypointEditorScreen(Minecraft mc, Waypoint waypoint)
    {
        ...
        {
            name = "";
            EntityClientPlayerMP i = mc.thePlayer;
            x = MathHelper.floor_double(i.posX);
            y = MathHelper.floor_double(i.posY);
            z = MathHelper.floor_double(i.posZ);
        }
        else
        {
            name = waypoint.name;
    ...
    public void drawScreen(int mx, int my, float f)
    {
        ...
        drawRect(titleLeft - 2, this.height / 2 - 71, titleRight + 2, this.height / 2 - 57, -1610612736);
        this.drawCenteredString(this.fontRendererObj, title, this.width / 2, this.height / 2 - 68, -1);
        String temp = Integer.toString(x).equals(this.xCoordTextField.displayString) ? "xCoord: (Current)" : "xCoord:";
        this.drawString(this.fontRendererObj, temp, (this.width - 150) / 2 + 1, this.height / 2 - 19, -1);
        temp = Integer.toString(y).equals(this.yCoordTextField.displayString) ? "yCoord: (Current)" : "yCoord:";
        this.drawString(this.fontRendererObj, temp, (this.width - 150) / 2 + 1, this.height / 2 - 9, -1);
