...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if ((REI_MINIMAP) && (!ReiMinimap.instance.useModloader)) {
            ReiMinimap.instance.onTickInGame(par1, this.mc);
          }
        ...
        if (this.on == true)
        {
        	this.mc.mcProfiler.startSection("armorgui");
...
//        	GL11.glPopMatrix();
            ...
            } else if(!(mc.thePlayer.getCurrentArmor(0) == null)){
                final ResourceLocation boots = new ResourceLocation("textures/items/" + this.mc.thePlayer.getCurrentArmor(0).getIconIndex().getIconName() + ".png");

                EnumChatFormatting red = EnumChatFormatting.DARK_RED;


                int maxdamageBoots = this.mc.thePlayer.getCurrentArmor(0).getItemDamageForDisplay();
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(0).getMaxDamage() - 75)){
                	red = EnumChatFormatting.DARK_RED;
                }
                
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(0).getMaxDamage() /2)){
                	red = EnumChatFormatting.RED;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(0).getMaxDamage() /3)){
                	red = EnumChatFormatting.YELLOW;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(0).getMaxDamage() /4)){
                	red = EnumChatFormatting.GOLD;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(0).getMaxDamage() /5)){
                	red = EnumChatFormatting.GREEN;
                }
            	
                var8.drawStringWithShadow(red + "" +  (this.mc.thePlayer.getCurrentArmor(0).getMaxDamage() - this.mc.thePlayer.getCurrentArmor(0).getItemDamageForDisplay()), 22, 65, 16777215);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                this.mc.getTextureManager().bindTexture(boots);
                
                mc.getTextureManager().bindTexture(boots);//blankTexture is a ResourceLocation btw
                drawTexturedQuadFit(2, 60, 16, 16, 0);
            } 
            
            if(this.mc.thePlayer.getCurrentArmor(1) == null){
            	
            } else if(!(mc.thePlayer.getCurrentArmor(1) == null)){
                final ResourceLocation boots = new ResourceLocation("textures/items/" + this.mc.thePlayer.getCurrentArmor(1).getIconIndex().getIconName() + ".png");

                EnumChatFormatting red = EnumChatFormatting.DARK_RED;


                int maxdamageBoots = this.mc.thePlayer.getCurrentArmor(1).getItemDamageForDisplay();
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(1).getMaxDamage() - 75)){
                	red = EnumChatFormatting.DARK_RED;
                }
                
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(1).getMaxDamage() /2)){
                	red = EnumChatFormatting.RED;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(1).getMaxDamage() /3)){
                	red = EnumChatFormatting.YELLOW;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(1).getMaxDamage() /4)){
                	red = EnumChatFormatting.GOLD;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(1).getMaxDamage() /5)){
                	red = EnumChatFormatting.GREEN;
                }
            	
                var8.drawStringWithShadow(red + "" +  (this.mc.thePlayer.getCurrentArmor(1).getMaxDamage() - this.mc.thePlayer.getCurrentArmor(1).getItemDamageForDisplay()), 22, 49, 16777215);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                this.mc.getTextureManager().bindTexture(boots);
                
                mc.getTextureManager().bindTexture(boots);//blankTexture is a ResourceLocation btw
                drawTexturedQuadFit(2, 44, 16, 16, 0);
            }
            
            if(this.mc.thePlayer.getCurrentArmor(2) == null){
            	
            } else if(!(mc.thePlayer.getCurrentArmor(2) == null)){
                final ResourceLocation boots = new ResourceLocation("textures/items/" + this.mc.thePlayer.getCurrentArmor(2).getIconIndex().getIconName() + ".png");

                EnumChatFormatting red = EnumChatFormatting.DARK_RED;


                int maxdamageBoots = this.mc.thePlayer.getCurrentArmor(2).getItemDamageForDisplay();
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(2).getMaxDamage() - 75)){
                	red = EnumChatFormatting.DARK_RED;
                }
                
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(2).getMaxDamage() /2)){
                	red = EnumChatFormatting.RED;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(2).getMaxDamage() /3)){
                	red = EnumChatFormatting.YELLOW;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(2).getMaxDamage() /4)){
                	red = EnumChatFormatting.GOLD;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(2).getMaxDamage() /5)){
                	red = EnumChatFormatting.GREEN;
                }
            	
                var8.drawStringWithShadow(red + "" +  (this.mc.thePlayer.getCurrentArmor(2).getMaxDamage() - this.mc.thePlayer.getCurrentArmor(2).getItemDamageForDisplay()), 22, 33, 16777215);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                this.mc.getTextureManager().bindTexture(boots);
                
                mc.getTextureManager().bindTexture(boots);//blankTexture is a ResourceLocation btw
                drawTexturedQuadFit(2, 28, 16, 16, 0);
            }
            
            if(this.mc.thePlayer.getCurrentArmor(3) == null){
            	
            } else if(!(mc.thePlayer.getCurrentArmor(3) == null)){
                final ResourceLocation boots = new ResourceLocation("textures/items/" + this.mc.thePlayer.getCurrentArmor(3).getIconIndex().getIconName() + ".png");

                EnumChatFormatting red = EnumChatFormatting.DARK_RED;


                int maxdamageBoots = this.mc.thePlayer.getCurrentArmor(3).getItemDamageForDisplay();
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(3).getMaxDamage() - 75)){
                	red = EnumChatFormatting.DARK_RED;
                }
                
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(3).getMaxDamage() /2)){
                	red = EnumChatFormatting.RED;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(3).getMaxDamage() /3)){
                	red = EnumChatFormatting.YELLOW;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(3).getMaxDamage() /4)){
                	red = EnumChatFormatting.GOLD;
                }
                if(maxdamageBoots <= (this.mc.thePlayer.getCurrentArmor(3).getMaxDamage() /5)){
                	red = EnumChatFormatting.GREEN;
                }
            	
                var8.drawStringWithShadow(red + "" +  (this.mc.thePlayer.getCurrentArmor(3).getMaxDamage() - this.mc.thePlayer.getCurrentArmor(3).getItemDamageForDisplay()), 22, 17, 16777215);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                this.mc.getTextureManager().bindTexture(boots);
                
                mc.getTextureManager().bindTexture(boots);//blankTexture is a ResourceLocation btw
                drawTexturedQuadFit(2, 12, 16, 16, 0);
            }
          ...
          if(mc.thePlayer.inventory.getCurrentItem() != null){
              ...
              int maxdamageBoots = this.mc.thePlayer.inventory.getCurrentItem().getItemDamageForDisplay();
        	  InventoryPlayer inven = mc.thePlayer.inventory;

        	  
//              GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
              
              
//              if(inven.getCurrentItem().getMaxDamage() > 1){
//                  var8.drawStringWithShadow(this.mc.thePlayer.inventory.getCurrentItem().getMaxDamage() + "", 22, 17, 16777215);
//              }
              var8.drawStringWithShadow(inven.getCurrentItem().getMaxStackSize() + "", 22, 81, 16777215);
              
              if(inven.getCurrentItem().getItem().getIdFromItem(inven.getCurrentItem().getItem()) > 255){
                  final ResourceLocation boots = new ResourceLocation("textures/items/" + this.mc.thePlayer.inventory.getCurrentItem().getIconIndex().getIconName() + ".png");

                  GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                  this.mc.getTextureManager().bindTexture(boots);
                  
                  mc.getTextureManager().bindTexture(boots);//blankTexture is a ResourceLocation btw
                  drawTexturedQuadFit(2, 76, 16, 16, 0);
              } else {
                  this.renderArmorGui(2, 76, par1);
              }
...
//          GL11.glPopMatrix();
    ...
    //Ir0nik
    private void renderArmorGui(int par2, int par3, float par4)
    {
        ItemStack var5 = this.mc.thePlayer.inventory.getCurrentItem();
