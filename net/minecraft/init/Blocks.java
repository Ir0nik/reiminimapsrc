...
public class Blocks
{
    ...
    public static final Block ore1 = (Block)Block.blockRegistry.getObject("ore1");
    public static final Block ore2 = (Block)Block.blockRegistry.getObject("ore2");
    public static final Block ore3 = (Block)Block.blockRegistry.getObject("ore3");
    public static final Block ore1_block = (Block)Block.blockRegistry.getObject("ore1_block");
    public static final Block ore2_block = (Block)Block.blockRegistry.getObject("ore2_block");
    public static final Block ore3_block = (Block)Block.blockRegistry.getObject("ore3_block");
    public static final Block invisible = (Block)Block.blockRegistry.getObject("invisible");
    public static final Block obsi_stairs = (Block)Block.blockRegistry.getObject("obsi_stairs");
    
    
    //Ir0nikFurnace
    public static final Block furnaceIr0nik = (Block)Block.blockRegistry.getObject("furnaceIr0nik");
    public static final Block lit_furnaceIr0nik = (Block)Block.blockRegistry.getObject("lit_furnaceIr0nik");
